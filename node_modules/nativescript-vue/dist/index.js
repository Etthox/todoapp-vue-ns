import { createBlock as createBlockCore, createElementBlock as createElementBlockCore, createElementVNode as createElementVNodeCore, createVNode as createVNodeCore, resolveComponent as resolveComponentCore, } from '@vue/runtime-core';
...
export function resolveComponent(name, maybeSelReference) {
 ...
 */
function maybeConvertToKnownComponentOrViewName(type) {
 ...
 */
function wrapCreate(originalFunction) {
    return ((type, ...args) => {
        return originalFunction(maybeConvertToKnownComponentOrViewName(type), ...args);
    });
}
...
export const createVNode = wrapCreate(createVNodeCore);
